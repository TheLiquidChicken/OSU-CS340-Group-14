...
CREATE TABLE IF NOT EXISTS `mydb`.`Customers` (
  ...
  `mostUsedMaterial` VARCHAR(30) NULL,
  `mostUsedColor` VARCHAR(30) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PartMachines` (
  ...
  PRIMARY KEY (`Parts_partID`, `Parts_Orders_orderID`, `Part_Order_Customer_customerID`, `Machines_machineID`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`PartMaterials` (
  ...
  PRIMARY KEY (`Parts_partID`, `Parts_Orders_orderID`, `Part_Order_Customer_customerID`, `Materials_materialID`, `Material_MaterialType_materialTypeID`, `Materials_Colors_colorID`),
